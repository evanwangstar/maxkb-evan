  ...
  applicationForm: {
    ...
    form: {
      ...
      appDescription: {
        ...
        placeholder:
          'Describe the application scenario and use, e.g.: AIKB assistant answering user questions about AIKB product usage'
      },
      aiModel: {
        label: 'AI Model',
    ...
    dialogues: {
      ...
      designated_answer:
        'Hello, I am AIKB Assistant. My knowledge base only contains information related to AIKB products. Please rephrase your question.'
    }
  },
  prompt: {
    defaultPrompt:
    ...
    defaultPrologue:
      'Hello, I am AIKB Assistant. You can ask me questions about using AIKB.\n- What are the main features of AIKB?\n- Which large language models does AIKB support?\n- What document types does AIKB support?'
  }
}
